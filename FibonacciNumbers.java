...
public class FibonacciNumbers extends JFrame {
	...
	private final JPanel eventThreadJPanel = new JPanel(new GridLayout(2, 2, 5,
			5));
	...
	public FibonacciNumbers() {
		...
		workerJPanel.setBorder(new TitledBorder(new LineBorder(Color.BLACK),
				"With SwingWorker"));
		...
		nextNumberJButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				n1 = n2;
				n2 = temp;
				System.out.println("temp = n1+n2 ~ " + temp + " " + n1 + " "
						+ n2);
				++count;
